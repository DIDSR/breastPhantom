...
class arteryBr {
	...
	// sType refers to segment type (equivalent to tree type)
		...
		arteryBr* firstChild;
		// pointer to last child branch
		arteryBr* lastChild;
		// pointer to previous sibling branch
		arteryBr* prevBranch;
		// pointer to next sibling branch
		arteryBr* nextBranch;
		// branch id number
		unsigned int id;
	...
	public:
		...
		arteryBr(arteryBr*, unsigned int, unsigned int, double);
		// constructor for other branches
		arteryBr(arteryBr*, arteryBr*, unsigned int, unsigned int, double);
